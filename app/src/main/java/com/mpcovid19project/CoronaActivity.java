...
import com.mpcovid19project.Adapter.CoronaAdapter;
import com.mpcovid19project.Adapter.FAQAdapter;
import com.mpcovid19project.Models.Corona;
import com.mpcovid19project.Models.FAQ;
import com.mpcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Madhya Pradesh").getJSONObject("districtData");
